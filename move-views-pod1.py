...
for dirpath, dirnames, filenames in os.walk("Pod1RepoTest"):
    for filename in [f for f in filenames if f.startswith("views")]:
        obi=dirpath
        ...
        save_path="C:\\Users\\capta\\dev\\LCSPods\\FinalShowcaseGenerator\\views.py\\Pod1"+"\\views ("+str(b[1][0])+").txt"
        firstpart='C:\\Users\\capta\\dev\\LCSPods\\FinalShowcaseGenerator\\'
        lastpart="\\views ("+(a[0])+").py"  #talk to nausher, figure way out to do it with py files
